...
DROP CONSTRAINT fk_PacientInternare

ALTER TABLE Internare
ADD CONSTRAINT fk_PacientInternare FOREIGN KEY (cod_p) REFERENCES Pacient(cod_p) ON DELETE CASCADE ON UPDATE CASCADE
...
ALTER TABLE Reteta
DROP CONSTRAINT fk_BoalaReteta;

ALTER TABLE Reteta
ADD CONSTRAINT fk_BoalaReteta FOREIGN KEY (cod_b) REFERENCES Boala(cod_b) ON DELETE CASCADE;

ALTER TABLE Reteta
DROP CONSTRAINT fk_PacientReteta;

ALTER TABLE Reteta
ADD CONSTRAINT fk_PacientReteta FOREIGN KEY (cod_p) REFERENCES Pacient(cod_p) ON DELETE CASCADE;
...
ALTER TABLE Reteta_Medicament
	DROP CONSTRAINT fk_Reteta

ALTER TABLE Reteta_Medicament
	ADD CONSTRAINT fk_Reteta FOREIGN KEY (cod_r) REFERENCES Reteta(cod_r) ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE Reteta_Medicament
	DROP CONSTRAINT fk_Medicament

ALTER TABLE Reteta_Medicament
	ADD CONSTRAINT fk_Medicament FOREIGN KEY (cod_m) REFERENCES Medicament(cod_m) ON DELETE CASCADE ON UPDATE CASCADE
...
ALTER TABLE Medic
ADD specializare VARCHAR(20);



UPDATE Medic SET specializare='Cardiologie' WHERE nume_m='Pop Ioan';
UPDATE Medic SET specializare='Pneumologie' WHERE nume_m='Ionescu Vasile';
...
INSERT INTO Asistent(nume_a) VALUES ('Donca Mihai');
...
INSERT INTO Pacient(nume_p, adresa_p,telefon_p) VALUES ('Traian Andrei', 'Teodor Mihali 60','0757345787');
...
INSERT Internare(cod_p, cod_m, cod_a, cod_s, data_internare, data_externare) VALUES
								(1, 1, 1, 1, '2022-07-10', '2022-07-13');


INSERT Internare(cod_p, cod_m, cod_a, cod_s, data_internare, data_externare) VALUES
								(4, 2, 3, 2, '2022-05-11', '2022-05-16');

INSERT INTO Reteta(cod_p,cod_b) VALUES (1, 1),
								  (4, 3);

INSERT INTO Reteta_Medicament(cod_r,cod_m) VALUES (6, 1),
												  (6, 2),
												  (6, 3),
												  (7, 6),
												  (7, 7);

INSERT Salon_Asistent(cod_s,cod_a) VALUES (2,5);

INSERT INTO Reteta(cod_p,cod_b) VALUES (1, 2);

INSERT INTO Reteta_Medicament(cod_r,cod_m) VALUES(8, 4),
												 (8, 5);


INSERT INTO Pacient(nume_p, adresa_p,telefon_p) VALUES ('Traian Andrei2', 'Teodor Mihali 60','0757345787');
select * from Pacient;
select * from Medic;
select * from Salon;
